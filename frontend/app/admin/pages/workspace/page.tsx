          ...
          >
            ...
            {expandedIdx === i && (
              <div className="border-t border-gray-100 p-4 space-y-4 bg-gray-50/50">
                ...
                <Field label="Headline" value={slide.title} onChange={(v) => updateSlide(i, 'title', v)} placeholder="e.g. Designed for Modern Workplaces" />
...
function IdeasTab({ data, onChange }: { data: any; onChange: (d: any) => void }) {
  ...
  const addItem = () => onChange({ ...data, items: [...items, { title: '', description: '', image: '', link: '', linkText: 'Read more', primaryButtonBg: '', primaryButtonTextColor: '', icon: 'Workspace', stats: '7 mins read', statsLabel: '' }] });
