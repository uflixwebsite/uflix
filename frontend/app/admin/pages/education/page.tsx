          ...
          >
            ...
            {expandedIdx === i && (
              <div className="border-t border-gray-100 p-4 space-y-4 bg-gray-50/50">
                ...
                <Field label="Headline" value={slide.title} onChange={(v) => updateSlide(i, 'title', v)} placeholder="e.g. Designed for Learning Environments" />
                ...
                return (
                  <div key={p._id} className="flex items-center gap-3 px-3 py-2 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(p.variants?.[0]?.name || p.variants?.[0]?.color) && <p className="text-xs text-gray-400">{p.variants?.[0]?.name || p.variants?.[0]?.color}</p>}
                    </div>
